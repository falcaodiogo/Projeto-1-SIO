...
<body style="background-color: #ffffff; font-family: monospace;">
	<!--Company Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #5347d4; color: white; padding: 5px;">
		<h2>DETI's Safe Shop</h2>
		<h6>O teu futuro em modo seguro, sem CTRL+Z!</h6>
		...
		<p align="center"
			...
			id="message; font-family: monospace;"></p>
	</div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>SIO Project</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=Mug">Mugs</a></li>
							<li><a href="index.jsp?type=Cup">Cups</a></li>
							<li><a href="index.jsp?type=T-Shirt">T-Shirts</a></li>
							<li><a href="index.jsp?type=Hoodie">Hoodies</a></li>
							<li><a href="index.jsp?type=Shirt">Shirts</a></li>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=Mug">Mugs</a></li>
							<li><a href="userHome.jsp?type=Cup">Cups</a></li>
							<li><a href="userHome.jsp?type=T-Shirt">T-Shirts</a></li>
							<li><a href="userHome.jsp?type=Hoodie">Hoodies</a></li>
							<li><a href="userHome.jsp?type=Shirt">Shirts</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=Mug">Mugs</a></li>
							<li><a href="adminViewProduct.jsp?type=Cup">Cups</a></li>
							<li><a href="adminViewProduct.jsp?type=T-Shirt">T-Shirts</a></li>
							<li><a href="adminViewProduct.jsp?type=Hoodie">Hoodies</a></li>
							<li><a href="adminViewProduct.jsp?type=Shirt">Shirts</a></li>
						</ul></li>
