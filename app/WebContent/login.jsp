			...
			<form action="./LoginSrv" method="post"
				...
				<div class="row">
				    <div class="col-md-12 form-group">
				        ...
				        <input type="text" placeholder="Enter E-mail" name="username" class="form-control" id="last_name">
				    </div>
				</div>
				<div class="row">
				    <div class="col-md-12 form-group">
				        <label for="last_name">Password</label>
				        <input type="password" placeholder="Enter Password" name="password" class="form-control" id="last_name">
				    </div>
				</div>
				<div class="row">
					<div class="col-md-12 form-group">
